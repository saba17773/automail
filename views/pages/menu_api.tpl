<?php $this->layout('layouts/dashboard', ['title' => 'Menu API']);?>

<section class="content">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Menu API</h3>
    </div>
    <div class="box-body">
      <!-- Button -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="form_menu">
          ...
          <input type="hidden" name="menu_category" value="api">
