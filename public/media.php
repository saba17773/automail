...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => 'files/' . $_media_path,               // path to files (REQUIRED)
			'URL'           => '/files/' . $_media_path, // URL to files (REQUIRED)
		...
		array(
			...
			'uploadAllow'   => array('application/pdf', 'image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.ms-excel','text/html'), // Same as above
